...
def process_files_to_csv():
    all_files = glob.glob('/Users/richardchao/Code/cs182-project/data/SpongeBob_SquarePants_Transcripts/*.txt')  # Change the path if your text files are in a different directory
    with open('spongebob_lines.csv', 'w', newline='', encoding='utf-8') as csvfile:
